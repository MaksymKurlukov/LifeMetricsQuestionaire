...
expect_same(array('lmq-pss10', 'lmq-shared-style', 'lmq-pss10', 'lmq-shared-style'), $GLOBALS['lmq_enqueued_styles'], 'shortcode enqueues pss10 style and shared style');
expect_same(array('lmq-shared-ui', 'lmq-shared-ui'), $GLOBALS['lmq_enqueued_scripts'], 'shortcode enqueues generic shared ui script');
