...
expect_same(array('lmq-pss10', 'lmq-shared-style', 'lmq-pss10', 'lmq-shared-style'), $GLOBALS['lmq_enqueued_styles'], 'shortcode adds generic style handle');
expect_same(array('lmq-pss10', 'lmq-shared-ui', 'lmq-pss10', 'lmq-shared-ui'), $GLOBALS['lmq_enqueued_scripts'], 'shortcode adds generic script handles');
